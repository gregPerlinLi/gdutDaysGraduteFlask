...
class EhallSession(IDSSession):
    ...
    def __init__(self, username, password, *args, **kwargs):
        ...
        # 获得这个服务于
        super().__init__(
            'http://ehall.gdut.edu.cn/login?service=http://ehall.gdut.edu.cn/new/index.html',
            username, password, *args, **kwargs
        )

    def use_app(self, app_id):
        self.get('http://ehall.gdut.edu.cn//appShow', params={
            'appId': app_id
        }, headers={
    ...
    def get_app_list(self, search_key=''):
        app_list = self.get('http://ehall.gdut.edu.cn/jsonp/serviceSearchCustom.json', params={
    ...
    def is_logged_in(self):
        ret =self.get('http://ehall.gdut.edu.cn/jsonp/userFavoriteApps.json').json()
        return ret
